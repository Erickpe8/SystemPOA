...
<x-modal name="reject-user-modal" :show="false">
    <div class="p-6">
        <!-- Header -->
        ...
        <div class="mb-6 p-4 rounded-lg bg-red-500/10 border border-red-500/20">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="font-semibold text-[var(--text)]" id="reject-user-name"></p>
                    <p class="text-sm text-[var(--text-muted)]" id="reject-user-email"></p>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col-reverse sm:flex-row gap-3 justify-end">
            <button type="button" onclick="closeModal('reject-user-modal')"
            ...
            <button type="button" onclick="confirmRejectUser()"
