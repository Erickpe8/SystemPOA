...
<div class="space-y-4">
    ...
    <div class="flex items-center gap-3 pb-4 border-b border-[var(--border)]">
        ...
        <div>
            ...
            <p class="text-sm text-[var(--text-muted)]">
                Revisa y aprueba nuevas solicitudes de acceso
            </p>
        </div>
    </div>
    ...
    @if ($pendingUsers->isEmpty())
        ...
        <div class="text-center py-12">
            <div
                class="w-20 h-20 mx-auto mb-4 rounded-full bg-green-500/10
                        flex items-center justify-center">
            ...
            @foreach ($pendingUsers as $user)
                <div
                    ...
                    <div class="flex gap-2">
                        <button
                            onclick="openApprovalModal({{ $user->id }}, '{{ $user->name }}', '{{ $user->email }}')"
